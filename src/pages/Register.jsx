...
import {ShowPassword, LoginGoogle, LoginButton} from '../components/buttons/Buttons'
  ...
  return (
    <div className='bg-dark-grey min-h-screen'>
			<div className='grid place-content-center ali pt-44 gap-10'>
				<h1 className='text-white font-bold text-7xl text-center drop-shadow-2xl'>OurList</h1>
				<div className={clsx('w-96 h-96 pt-8',
															'bg-md-grey rounded-3xl',
															'flex flex-col items-center',
                              'drop-shadow-2xl')}>
					<p className='text-white font-bold text-2xl'>Welcome</p>
          <form onSubmit={(e) => onHandleSubmit} className={clsx('flex flex-col items-center')}>
          ...
          <div className={clsx('flex space-x-1 mt-7')}>
            ...
            <Link to="/register" className={clsx('text-green font-bold')}>Register</Link>
          </div>
				</div>
			</div>
    </div>
